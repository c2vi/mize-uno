  ...
  var e = {
      448: (e, n, t) => {
        ...
        function Wa(e, n, t, r) {
          ...
          'object' == typeof a && null !== a
            ? (l.context = _a(a))
            : ((a = Ol(n) ? Tl : zl.current), (l.context = Ll(e, a))),
    ...
    const g = function () {
      ...
      return (
        ...
        h.createElement(
          h.Fragment,
          null,
          h.createElement('h1', null, 'Welcome to the Player Render!!')
        )
      )
    }
    function y(e, n) {
            ...
            { key: 'connectedCallback', value: function () {} },
            {
              ...
              value: function (e) {
                ...
                this.attachShadow({ mode: 'open' }).appendChild(t),
                  ...
                  (w = function (t) {
                    if (t) {
                      var r = o((0, h.useState)({}), 2),
                        l = r[0],
                        a = r[1]
                      return (
                        n.items[t.id]
                          ? (n.items[n.id].raw.update(l),
                            (n.items[t.id].item = l),
                            (n.items[t.id].item = a))
                          : ((n.items[t.id] = {
                              item: l,
                            ...
                            mize.get_item(t.id, function (e) {
                              ;(n.items[e.id].raw = e),
                                n.items[e.id].setItem(e.get_parsed())
                            })),
                        [l, a]
                      )
                    }
                    var u = o((0, h.useState)(e.get_parsed()), 2),
                      i = u[0],
                      s = u[1]
                    return (
                      n.items[n.id]
                        ? (n.items[n.id].raw.update(i),
                          (n.items[n.id].item = i),
                          (n.items[n.id].item = s))
                        : (n.items[n.id] = {
                            item: i,
                  ...
                  (0, v.s)(t).render(h.createElement(g, null))
              },
            },
            {
              key: 'updateCallback',
