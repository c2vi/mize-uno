...
;(() => {
  ...
  var e = {
      448: (e, n, t) => {
          ...
          return (
            'object' == typeof a && null !== a
              ...
              : ((l = Ll(n) ? Tl : Nl.current),
                (a = (r = null != (r = n.contextTypes)) ? Ol(e, l) : Pl)),
            (n = new n(t, a)),
            (e.memoizedState =
        ...
        function Wa(e, n, t, r) {
          var l = e.stateNode
          ;(l.props = t), (l.state = e.memoizedState), (l.refs = Ua), Oa(e)
          var a = n.contextType
          'object' == typeof a && null !== a
            ? (l.context = _a(a))
            : ((a = Ll(n) ? Tl : Nl.current), (l.context = Ol(e, a))),
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 == (32768 & n.flags))) {
              if (null !== (t = qu(t, n, Li))) return void (Ti = t)
            } else {
              if (null !== (t = Ku(t, n)))
        ...
        function _s(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zi === e &&
              (Oi & t) === t &&
              (4 === Mi ||
              (3 === Mi && (130023424 & Oi) === Oi && 500 > Ge() - Vi)
                ? ds(e, 0)
                : (ji |= t)),
            rs(e, n)
        }
              ...
              e: {
                ...
                if (((r = u.element), o.isDehydrated)) {
                  if (
                    ...
                    n = Ou(e, n, r, t, (l = cu(Error(a(423)), n)))
                    break e
                  }
                  if (r !== l) {
                    n = Ou(e, n, r, t, (l = cu(Error(a(424)), n)))
                    break e
                  }
                  for (
  ...
  ;(() => {
    ...
    function i(e, t) {
      for (var r = 0; r < t.length; r++) {
        ...
        ;(l.enumerable = l.enumerable || !1),
          ...
          Object.defineProperty(e, n(l.key), l)
      }
    }
    function s(e, n) {
      return (
    ...
    const b = function () {
      ...
      return (
        ...
        h.createElement(
          h.Fragment,
          null,
          h.createElement('h1', null, 'Welcome to the UNO Lobby.'),
          'Cards: ',
          n.cards_of_player,
          h.createElement(
            'button',
              ...
              onClick: function () {
                t(function (e) {
                  return y(
                    y({}, e),
                    {},
                    { cards_of_player: e.cards_of_player + ['green_5'] }
                  )
                })
              },
            },
    ...
    var S = {},
      E = (function (e) {
        ...
        function d() {
          return u(this, d), a.apply(this, arguments)
        }
        return (
          (n = d),
          (t = [
            {
              ...
              value: function () {
                ...
                this.attachShadow({ mode: 'open' }).appendChild(t),
                  ...
                  (S = function () {
                    if (0 == e.length) {
                      var t = o((0, h.useState)({ _id: 'hi' }), 2),
                        r = t[0],
                        l = t[1]
                      return (n.items[n.id] = { item: r, setItem: l }), [r, l]
                    }
                  })
                var r = (0, v.s)(t)
                r.render(h.createElement(b, null))
              },
            },
            {
              key: 'getItemCallback',
              value: function (e) {
                ;(this.item_raw = e),
                  this.items[e.id].setItem(function (n) {
                    return k(k({}, n), e.get_parsed())
                  })
              },
            },
            {
              ...
              value: function (e) {
                ;(this.item_raw = e.now),
                  this.items[e.now.id].setItem(function (n) {
                    return k(k({}, n), e.now.get_parsed())
                  })
              },
            },
          ]),
